...
function loop() {
    ...
    if (harvesters.length < 1 ||
        ...
        helpers_find_1.HelpersFind.getRoomTerminalFreeStorageAmount(Game.rooms['E47N16']) > 10000) {
    ...
    if (harvesters2.length < 1) {
        ...
        helpers_find_1.HelpersFind.getRoomTerminalFreeStorageAmount(Game.rooms['E47N17']) > 10000) {
        const newName = 'Extractor' + Game.time;
        Game.spawns['Spawn2'].spawnCreep([
    ...
    linkFrom2.transferEnergy(linkToBuild2, Math.min(linkToBuild2.store.getCapacity(RESOURCE_ENERGY) -
        linkToBuild2.store[RESOURCE_ENERGY], linkFrom2.store[RESOURCE_ENERGY]));
    //}
    // try {
