...
function loop() {
  ...
  const harvesters = _.filter(
    Game.creeps,
    creep =>
      creep.memory.role === enums_1.CreepRole.harvester &&
      creep.memory.room === '1'
  );
  ...
  const builders = _.filter(
    Game.creeps,
    creep =>
      creep.memory.role === enums_1.CreepRole.builder &&
      creep.memory.room === '1'
  );
  const upgraders = _.filter(
    Game.creeps,
    creep =>
      creep.memory.role === enums_1.CreepRole.upgrader &&
      creep.memory.room === '1'
  );
  const extractors = _.filter(
    Game.creeps,
    creep =>
      creep.memory.role === enums_1.CreepRole.extractor &&
      creep.memory.room === '1'
  );
  const energizers = _.filter(
    Game.creeps,
    creep =>
      creep.memory.role === enums_1.CreepRole.energizer &&
      creep.memory.room === '1'
  );
  ...
  const claimers2 = _.filter(
    Game.creeps,
    creep => creep.memory.role === enums_1.CreepRole.claimer
  );
  const uptownBuilders2 = _.filter(
    Game.creeps,
    creep => creep.memory.role === enums_1.CreepRole.uptownBuilder
  );
  ...
  if (
    ...
    if (harvestersE.length < 1) {
      if (
        Game.spawns['Spawn1'].spawnCreep(
          ...
          newName,
          {memory: {role: enums_1.CreepRole.harvester, room: '1'}}
    ...
    Game.spawns['Spawn1'].spawnCreep(
      ...
      newName,
      {memory: {role: enums_1.CreepRole.builder, room: '1'}}
    );
    ...
    Game.spawns['Spawn1'].spawnCreep(
      ...
      newName,
      {memory: {role: enums_1.CreepRole.upgrader, room: '1'}}
    );
  } else if (
    extractors.length < 1 &&
    Game.rooms['E47N16'].lookForAt('mineral', 20, 21)[0].mineralAmount > 0 &&
    helpers_1.HelpersFind.getRoomTerminalFreeStorageAmount(
      Game.rooms['E47N16']
    ) > 0
  ) {
    ...
    Game.spawns['Spawn1'].spawnCreep(
      ...
      newName,
      {memory: {role: enums_1.CreepRole.extractor, room: '1'}}
    );
  ...
  if (harvesters2.length < 1) {
    ...
    Game.spawns['Spawn2'].spawnCreep(
      ...
      newName,
      {memory: {role: enums_1.CreepRole.harvester, room: '2'}}
    );
    ...
    Game.spawns['Spawn2'].spawnCreep(
      ...
      newName,
      {memory: {role: enums_1.CreepRole.upgrader, room: '2'}}
    );
    ...
    Game.spawns['Spawn2'].spawnCreep(
      ...
      newName,
      {memory: {role: enums_1.CreepRole.builder, room: '2'}}
    );
    ...
    Game.spawns['Spawn2'].spawnCreep(
      ...
      newName,
      {memory: {role: enums_1.CreepRole.claimer, room: '2'}}
    );
    ...
    Game.spawns['Spawn2'].spawnCreep(
      ...
      newName,
      {memory: {role: enums_1.CreepRole.uptownBuilder, room: '2'}}
    );
  } else if (
    ...
    Game.spawns['Spawn2'].spawnCreep(
      ...
      newName,
      {memory: {role: enums_1.CreepRole.extractor, room: '2'}}
    );
  ...
  const roomTotalEnergyForSpawningAvailable3 = helpers_1.HelpersFind.getRoomTotalEnergyForSpawningAvailable(
    new Room('E48N17')
  );
  if (harvesters3.length < 1) {
    ...
    if (roomTotalEnergyForSpawningAvailable3 >= 1500) {
      Game.spawns['Spawn3'].spawnCreep(
        ...
        newName,
        {memory: {role: enums_1.CreepRole.harvester, room: '3'}}
      );
    ...
    if (roomTotalEnergyForSpawningAvailable3 >= 1500) {
      Game.spawns['Spawn3'].spawnCreep(
        ...
        newName,
        {memory: {role: enums_1.CreepRole.upgrader, room: '3'}}
      );
    } else if (roomTotalEnergyForSpawningAvailable3 >= 800) {
      Game.spawns['Spawn3'].spawnCreep(
        [
    ...
    if (
      helpers_1.HelpersFind.findSomethingToBuild(
        new Room('E48N17'),
        250000,
        false
      ).length > 0
      ...
      if (roomTotalEnergyForSpawningAvailable3 >= 1500) {
        Game.spawns['Spawn3'].spawnCreep(
          ...
          newName,
          {memory: {role: enums_1.CreepRole.builder, room: '3'}}
        );
      } else if (roomTotalEnergyForSpawningAvailable3 >= 800) {
        Game.spawns['Spawn3'].spawnCreep(
          [
  ...
  for (const name of Object.keys(Game.creeps)) {
    ...
    if (creep.memory.role === enums_1.CreepRole.claimer) {
      uptown_claimer_1.RoleClaimer.run(creep);
    }
