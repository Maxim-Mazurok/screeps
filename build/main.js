...
module.exports.loop = () => {
    ...
    const uptownHarvesters = _.filter(Game.creeps, (creep) => creep.memory.role === 'uptown-harvester');
    const uptownClaimers = _.filter(Game.creeps, (creep) => creep.memory.role === 'uptown-claimer');
    if (harvesters.length < 1 ||
        ...
        Game.spawns['Spawn1'].spawnCreep([
            ...
            CARRY,
            CARRY,
        ], newName, { memory: { role: 'uptown-harvester', roomN: '1' } });
    }
        ...
        Game.spawns['Spawn1'].spawnCreep([
            ...
            CLAIM,
            CLAIM,
        ], newName, { memory: { role: 'uptown-claimer', roomN: '1' } });
    }
