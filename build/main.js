...
module.exports.loop = () => {
    ...
    const harvesters = _.filter(Game.creeps, (creep) => creep.memory.role === 'harvester' && creep.memory.roomN === '1');
    const harvestersE = _.filter(Game.creeps, (creep) => creep.memory.role === 'harvester' &&
        creep.memory.roomN === '1' &&
        creep.memory.e === '1');
    const builders = _.filter(Game.creeps, (creep) => creep.memory.role === 'builder' && creep.memory.roomN === '1');
    const upgraders = _.filter(Game.creeps, (creep) => creep.memory.role === 'upgrader' && creep.memory.roomN === '1');
    const extractors = _.filter(Game.creeps, (creep) => creep.memory.role === 'extractor' && creep.memory.roomN === '1');
    const energizers = _.filter(Game.creeps, (creep) => creep.memory.role === 'energizer' && creep.memory.roomN === '1');
    const harvesters2 = _.filter(Game.creeps, (creep) => creep.memory.role === 'harvester' && creep.memory.roomN === '2');
    ...
    const builders3 = _.filter(Game.creeps, (creep) => creep.memory.role === 'builder' && creep.memory.roomN === '3');
    const harvesters3 = _.filter(Game.creeps, (creep) => creep.memory.role === 'harvester' && creep.memory.roomN === '3');
    ...
    */
    if (harvesters.length < 1 ||
        ...
        if (harvestersE.length < 1) {
            ...
            ], newName, { memory: { role: 'harvester', roomN: '1' } }) === ERR_NOT_ENOUGH_ENERGY) {
            ...
            Game.spawns['Spawn1'].spawnCreep([
                ...
                ..._.fill(_.times(10), WORK),
                ..._.fill(_.times(7), CARRY),
            ], newName, { memory: { role: 'harvester', roomN: '1' } });
        }
    }
        ...
        ], newName, { memory: { role: 'builder', roomN: '1' } });
    }
        ...
        ], newName, { memory: { role: 'upgrader', roomN: '1' } });
    ...
    if (harvesters2.length < 1) {
        ...
        Game.spawns['Spawn2'].spawnCreep([
            ...
            ..._.fill(_.times(10), WORK),
            ..._.fill(_.times(7), CARRY),
        ], newName, { memory: { role: 'harvester', roomN: '2' } });
    }
        ...
        Game.spawns['Spawn2'].spawnCreep([..._.fill(_.times(6), MOVE), ..._.fill(_.times(2), CLAIM)], newName, { memory: { role: 'claimer', roomN: '2' } });
    }
